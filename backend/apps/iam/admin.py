...
from apps.iam.models import MenuCatalogEntry, MembershipRole, MembershipScope, PermissionCatalogEntry, Role, RolePermission, TenantMembership, User
...
@admin.register(MenuCatalogEntry)
class MenuCatalogEntryAdmin(admin.ModelAdmin):
    list_display = ("workspace", "group", "kind", "label", "href", "sort_order", "is_active")
    list_filter = ("workspace", "group", "kind", "is_active")
    search_fields = ("workspace", "group", "label", "href", "blurb", "permission_keys")
    readonly_fields = ("created_at", "updated_at")
