...
PERMISSION_CATALOG: tuple[PermissionDefinition, ...] = (
    ...
    PermissionDefinition("reports.payroll.export", "Export payroll reports", "Reports", "Export payroll reports.", "critical", True, "reports", "", ("hr-admin", "payroll-finance-manager")),
    ...
    PermissionDefinition("reports.compliance.export", "Export compliance reports", "Reports", "Export compliance reports.", "critical", True, "reports", "", ("hr-admin", "payroll-finance-manager")),
