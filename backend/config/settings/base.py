...
HRMS_PUBLIC_APP_URL = os.getenv("HRMS_PUBLIC_APP_URL", "http://localhost:3000").rstrip("/")
PASSWORD_RESET_TIMEOUT = env_int("DJANGO_PASSWORD_RESET_TIMEOUT", 60 * 60 * 24 * 2)
...
# switch to Amazon SES SMTP with deployment-managed secrets.
...
PAYROLL_ARTIFACT_STORAGE_CONTROL_VERIFIERS: dict = {}
PAYROLL_ARTIFACT_STORAGE_CONTROL_VERIFICATION_MODE = "declaration"
...
PAYROLL_PROVIDER_HTTP_TRANSPORTS: dict = {}
PAYROLL_PROVIDER_PACKAGES: dict = {}
PAYROLL_BANK_PAYOUT_CLIENTS: dict = {}
PAYROLL_ACCOUNTING_JOURNAL_CLIENTS: dict = {}
PAYROLL_STATUTORY_FILING_CLIENTS: dict = {}
