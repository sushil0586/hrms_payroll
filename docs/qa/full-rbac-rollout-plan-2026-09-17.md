...
| --- | --- | --- |
| Platform Admin permission catalog has DB-backed metadata editing, but no approval/version workflow yet | Platform team can maintain labels, module, risk, active state, assignability, and plan/module metadata; adding/removing runtime permission keys still needs governed versioning before launch use | RBAC-10C |
