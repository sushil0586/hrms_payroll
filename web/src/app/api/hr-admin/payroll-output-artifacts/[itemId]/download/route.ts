...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  const upstreamResponse = await fetch(`${API_BASE_URL}/hr-admin/payroll-output-artifacts/${itemId}/download/${query}`, {
  ...
  [
    ...
    "x-payroll-storage-key",
    "x-payroll-storage-provider",
    "x-payroll-storage-version",
    "x-payroll-download-strategy",
    "x-payroll-retention-policy",
  ].forEach((key) => {
