  ...
  const buildDemoPayrollFinanceHandoffSetup = (): HrAdminPayrollFinanceHandoffSetupResponse => {
    ...
    const deliveryRoutes: Record<string, Record<string, string | boolean | Record<string, unknown>>> = {
      bank_advice: {
        ...
        channel_ref: "payroll.channel.bank.sftp.primary.v1",
        retry_policy_ref: "payroll.delivery.retry.bank.v1",
        adapter_ref: "bank-neft.manual.adapter.v1",
        submission_mode: "manual_sftp",
        submission_profile_ref: "bank-neft.payment-advice.submit.v1",
        request_schema_ref: "bank-neft.payment-advice.request.v1",
        response_schema_ref: "bank-neft.payment-advice.response.v1",
        callback_profile_ref: "bank-neft.callback.manual.v1",
        callback_verification_ref: "bank-neft.callback.manual-check.v1",
        certification_profile_ref: "bank-neft.utr.certificate.v1",
        certification_required: false,
      },
      accounting_export: {
        provider_ref: "payroll.provider.accounting.manual.v1",
        channel_ref: "payroll.channel.accounting.export.v1",
        retry_policy_ref: "payroll.delivery.retry.standard.v1",
        adapter_ref: "tally-export.manual.adapter.v1",
        submission_mode: "file_export",
        submission_profile_ref: "tally.accounting.import.submit.v1",
        request_schema_ref: "tally.accounting.import.request.v1",
        response_schema_ref: "tally.accounting.import.response.v1",
        callback_profile_ref: "tally.callback.manual.v1",
        callback_verification_ref: "tally.callback.manual-check.v1",
        certification_profile_ref: "tally.import.audit.v1",
        certification_required: false,
      },
      statutory_report: {
        provider_ref: "payroll.provider.statutory.manual.v1",
        channel_ref: "payroll.channel.statutory.portal.v1",
        retry_policy_ref: "payroll.delivery.retry.statutory.v1",
        adapter_ref: "statutory-portal.manual.adapter.v1",
        submission_mode: "manual_portal",
        submission_profile_ref: "statutory.portal.upload.submit.v1",
        request_schema_ref: "statutory.portal.upload.request.v1",
        response_schema_ref: "statutory.portal.upload.response.v1",
        callback_profile_ref: "statutory.portal.callback.manual.v1",
        callback_verification_ref: "statutory.portal.callback.manual-check.v1",
    ...
    const providerDeliveries = financeArtifacts.map((artifact, index) => {
      ...
      return {
        ...
        response_snapshot: {
          ...
          provider_batch_ref: "BANK-ACK-2026-08",
          external_reference: externalReference,
          failure_code: failureCode,
          failure_reason: failureReason,
        },
        ...
        config_snapshot: {
          ...
          certification_evidence: {
            ...
            external_reference: externalReference,
            evidence_refs: failedRetryDemo ? [] : certificationRequired ? [`clear://certificates/${artifact.id}.pdf`] : [],
          },
