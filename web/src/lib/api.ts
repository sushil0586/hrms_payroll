...
function getDemoData<T>(path: string): T {
  ...
  const buildDemoTenantAdminConsole = (): TenantAdminConsole => {
    ...
    const demoPermission = (permission: Omit<TenantAdminConsole["role_management"]["permission_catalog"][number], "required_entitlement" | "is_available" | "unavailable_reason">) => ({
      ...permission,
      required_entitlement: permission.required_module === "payroll" ? "payroll" : "core_hr",
      is_available: true,
      unavailable_reason: "",
    });
    return {
      ...
      role_management: {
        roles: [
          {
            ...
            code: "tenant-admin",
            name: "Tenant Admin",
            description: "Owns account-level users, plan, settings, and support access.",
            is_system_role: true,
            is_active: true,
            active_membership_count: 1,
            permission_keys: ["tenant.users.manage", "tenant.settings.view", "tenant.roles.manage"],
          },
          {
            id: "role-hr-admin",
            code: "hr-admin",
            name: "HR Admin",
            description: "Runs HR setup, employee lifecycle, policy, and payroll preparation.",
            is_system_role: true,
            is_active: true,
            active_membership_count: 1,
            permission_keys: ["employees.view", "employees.create", "employees.edit", "payroll.inputs.manage"],
          },
          {
            id: "role-payroll-reviewer",
            code: "payroll-reviewer",
            name: "Payroll Reviewer",
            description: "Custom demo role for payroll review and exception checks.",
        ...
        permission_catalog: [
          demoPermission({
            ...
            module: "Tenant Admin",
            description: "Invite, activate, suspend, revoke, and update tenant users.",
            risk_level: "high",
            tenant_assignable: true,
            required_module: "tenant-admin",
            required_plan: "",
            default_role_codes: ["tenant-admin"],
          }),
          demoPermission({
            key: "tenant.roles.manage",
            label: "Manage tenant roles",
            module: "Tenant Admin",
            description: "Create and update tenant custom roles.",
            risk_level: "critical",
            tenant_assignable: true,
            required_module: "tenant-admin",
            required_plan: "",
          ...
          demoPermission({
            key: "tenant.settings.view",
            label: "View tenant settings",
            module: "Tenant Admin",
            description: "View tenant settings and governed account controls.",
            risk_level: "low",
            tenant_assignable: true,
            required_module: "tenant-admin",
            required_plan: "",
          ...
          demoPermission({
            key: "payroll.inputs.manage",
            label: "Manage payroll inputs",
            module: "Payroll",
            description: "Manage payroll inputs and snapshots.",
            risk_level: "high",
            tenant_assignable: true,
          ...
          demoPermission({
            ...
            module: "Payroll",
            description: "Review payroll runs and exceptions.",
            risk_level: "high",
            tenant_assignable: true,
            required_module: "payroll",
            required_plan: "",
            default_role_codes: ["hr-admin", "payroll-finance-manager"],
          }),
        ],
        available_actions: [
