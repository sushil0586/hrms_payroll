...
import { configurationFormVisualRoutes } from "../helpers/routes";
import { screenshotName, visualViewports } from "../helpers/screenshots";

test.describe("configuration form visual baseline", () => {
  for (const route of configurationFormVisualRoutes) {
